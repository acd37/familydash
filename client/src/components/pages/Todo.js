            ...
            <div>
                <form onSubmit={this.handleCreateTodo} className='ui form'>
                    <div className={`field ${errors.description ? 'error' : ''}`}>
                        <label>
                            {errors.description ? <p>{errors.description}</p> : 'Add Task'}
                        </label>
                                ...
                                <Popup
                                        ...
                                        <List selection verticalAlign='middle' size='tiny'>
                                            {users.map(user => (
                                                <List.Item
                                                    key={user.id}
                                                    onClick={() =>
                                                        this.handleTaskAssignment(todo, user.id)
                                                    }>
                                            ...
                                            <List.Item
                                                onClick={() =>
                                                    this.handleTaskAssignment(todo, null)
                                                }>
                                                <Image
                                                    avatar
                                    ...
                                    trigger={
                                        <img
                                            ...
                                            src={this.getAssignedUserProfilePhoto(
                                                todo.assignedUser
                                            )}
                                        />
                                    }
...
export default connect(mapStateToProps, { getTodos, createTodo, deleteTodo, updateTodo })(Todo);
